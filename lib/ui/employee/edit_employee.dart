...
class EditEmployeePage extends StatefulWidget {
  final bool editingOwn;
  const EditEmployeePage({Key? key, this.editingOwn = false}) : super(key: key);
...
class _EditEmployeePageState extends State<EditEmployeePage> {
  ...
  void initState() {
    ...
    super.initState();
    bloc.initEditEmployeeDetails(editingOwn: widget.editingOwn);
  }
  @override
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 10),
                AppTextField(
                  controller: bloc.insta,
                  title: 'Instagram link',
                  showTitle: false,
                ),
                const SizedBox(height: 10),
                AppTextField(
                  controller: bloc.linkedIn,
                  title: 'LinkedIn link',
                  showTitle: false,
                ),
                const SizedBox(height: 10),
