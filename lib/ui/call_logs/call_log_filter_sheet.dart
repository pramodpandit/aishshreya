...
class CallLogFilterSheet extends StatefulWidget {
  const CallLogFilterSheet({Key? key}) : super(key: key);

  @override
  State<CallLogFilterSheet> createState() => _CallLogFilterSheetState();
}

class _CallLogFilterSheetState extends State<CallLogFilterSheet> {

  late final CallLogBloc bloc;
  @override
  void initState() {
    bloc = context.read<CallLogBloc>();
    super.initState();
    bloc.initFilterSort();
  }
